...
class SVM:
    ...
    def solve(self):
        ...
        """
        preprocessing = [StandardScaler(),MinMaxScaler(), PowerTransformer(method='yeo-johnson'), RobustScaler(quantile_range=(25,75)),MaxAbsScaler()]
        
        model = SVC(kernel='rbf', C=2.0, gamma=0.098)
        pipeline = Pipeline([('preprocessing', preprocessing[0]), ('model', model)])
        # Using StandardScaler as preprocessing gives me max accuracy
